...
86.  FC, T. Augustin (2007). Multinomial nonparametric predictive inference with sub-categories. In: Proceedings ISIPTA'07, 77-86, paper also available [here](ISIPTA07-proceedings-mnpi.pdf).
87.  FC, B. Houlding, S.G. Parkinson (2007). Jury size and composition - a predictive approach. In: Proceedings ISIPTA'07, 87-96, paper also available [here](ISIPTA07-proceedings-juries.pdf).
...
90.  P. Coolen-Schrijner, T.A. Maturi, FC (2007). Nonparametric predictive precedence testing for two groups. Proceedings Mathematical Methods in Reliability 2007, Glasgow, July 2007, CD-ROM, paper also available [here](mmr07-prec.pdf).
91.  FC, P. Coolen-Schrijner (2007). Nonparametric predictive inference for voting systems. Proceedings Mathematical Methods in Reliability 2007, Glasgow, July 2007, CD-ROM, paper also available [here](mmr07-voting.pdf).
92.  M. Troffaes, FC (2007). On the use of the Imprecise Dirichlet Model in fault trees. Proceedings Mathematical Methods in Reliability 2007, Glasgow, July 2007, CD-ROM, paper also available [here](mmr07-troffaes.pdf).
93.  FC, P. Coolen-Schrijner (2007). Nonparametric predictive inference for Bernoulli quantities: two examples. Proceedings 56th ISI Conference, Lisbon, August 2007, CD-ROM, paper also available [here](ISI2007-npi.pdf).
...
97.  FC, P. Coolen-Schrijner (2007). Bayesian reliability demonstration. Encyclopedia of Statistics in Quality and Reliability, F. Ruggeri, R. Kenett, F.W. Faltin (eds). Wiley, pp. 196-202. Preprint version available [here](brd-review.pdf) (with permission from Wiley).
98.  FC, L.V. Utkin (2008). Imprecise reliability. Encyclopedia of Quantitative Risk Analysis and Assessment, E.L. Melnick, B.S. Everitt (eds). Wiley, pp. 875-881. Preprint version available [here](ir-review.pdf) (with permission from Wiley).
99.  FC (2008). Parametric probability distributions in reliability. Encyclopedia of Quantitative Risk Analysis and Assessment, E.L. Melnick, B.S. Everitt (eds). Wiley, pp. 1255-1260. Preprint version available [here](pmdist.pdf) (with permission from Wiley).
100.  T.A. Maturi, P. Coolen-Schrijner, FC (2008). Early termination of experiments in nonparametric predictive comparisons. Proceedings International Workshop on Applied Probability 2008, Compiegne, France, July 2008, CD-ROM, paper also available [here](IWAP08paper.pdf).
...
167.  FC (2012). On some statistical aspects of software testing and reliability. In: Complex Systems and Dependability, W. Zamojski, J. Mazurkiewicz, J. Sugier, T. Walkowiak, J. Kacprzyk (editors). Springer, Berlin, pp. 103-113 ([preprint version](Springer12-preprint2.pdf)).
168.  FC, T. Coolen-Maturi (2012). Generalizing the signature to systems with multiple types of components. In: Complex Systems and Dependability, W. Zamojski, J. Mazurkiewicz, J. Sugier, T. Walkowiak, J. Kacprzyk (editors). Springer, Berlin, pp. 115-130 ([preprint version](Springer12-preprint1.pdf)).
